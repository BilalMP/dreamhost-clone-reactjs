...
const WordpressHosting = () => {
    return (
        < div className='flex flex-col justify-center justify-items-start rounded-lg shadow-2xl py-5 px-5 h-[300px]' >
            ...
            <h1 className='capitalize text-lg font-bold my-5'>wordpress hosting</h1>
...
const WebsiteHostig = () => {
    return (
        < div className='flex flex-col justify-center justify-items-start rounded-lg shadow-2xl py-5 px-5 h-[300px]' >
            ...
            <h1 className='capitalize text-lg font-bold my-5'>website hosting</h1>
...
const DedicatedHosting = () => {
    return (
        < div className='flex flex-col justify-center justify-items-start rounded-lg shadow-2xl py-5 px-5 h-[300px]' >
            ...
            <h1 className='capitalize text-lg font-bold my-5'>dedicated hosting</h1>
...
const CloudHosting = () => {
    return (
        < div className='flex flex-col justify-center justify-items-start rounded-lg shadow-2xl py-5 px-5 h-[300px]' >
            ...
            <h1 className='capitalize text-lg font-bold my-5'>cloud hosting</h1>
...
const VPSHosting = () => {
    return (
        < div className='flex flex-col justify-center justify-items-start rounded-lg shadow-2xl py-5 px-5 h-[300px]' >
            ...
            <h1 className='capitalize text-lg font-bold my-5'>VPS hosting</h1>
...
const ManagedVirtualPrivateServer = () => {
    return (
        < div className='flex flex-col justify-center justify-items-start rounded-lg shadow-2xl py-5 px-5 h-[300px]' >
            <h1 className='capitalize text-lg font-bold my-5'>Managed Virtual Private Servers</h1>
