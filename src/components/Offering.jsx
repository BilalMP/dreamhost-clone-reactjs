        ...
        <Container>
            <div className="flex justify-center items-center px-10 my-10">
                <div className="w-1/2">
                    ...
                    <p className='text-sm mt-10'>No matter how small or large your business, <br /> DreamHost caters to individuals and groups <br /> alike for your unique hosting scenario.</p>
                </div>
                <div className="w-1/2">
